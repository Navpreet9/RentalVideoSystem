...
namespace RentalVideoSystem
{
    public class Database
    {

        SqlConnection SqlConn = new SqlConnection("Data Source = (localdb)\\MSSQLLocalDB;Initial Catalog =RentalVideoSystem; Integrated Security = True");
